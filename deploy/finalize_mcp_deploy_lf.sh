...
printf '== versions ==\n'
docker exec xiaomiao-bot bash -lc 'python --version; node --version 2>/dev/null || true; npm --version 2>/dev/null || true; npx --version 2>/dev/null || true; uvx --version 2>/dev/null || true; git --version 2>/dev/null || true'
printf '== restart ==\n'
...
printf '== logs ==\n'
docker logs --tail=160 xiaomiao-bot
printf '== http smoke ==\n'
